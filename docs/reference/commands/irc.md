...
Options:
  ...
  --freeze-links / --no-freeze-links
                                  Freeze parent atoms of link hydrogens when the
                                  input is PDB.  [default: freeze-links]
  ...
  --out-dir TEXT                  Output directory (used unless YAML sets
                                  irc.out_dir).  [default: ./result_irc/]
