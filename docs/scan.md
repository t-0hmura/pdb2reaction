...
Drive a reaction coordinate by scanning bond distances with harmonic restraints. Use `--scan-lists/-s` to define targets as either a YAML/JSON spec file path (recommended) or inline Python literals.
