...
def main() -> int:
    ...
    steps: list[tuple[str, list[str]]] = [
        ("Regenerate references", [sys.executable, "scripts/generate_reference.py"]),
        ("Verify generated reference is up-to-date",
         ["git", "diff", "--exit-code",
          "docs/reference/commands", "docs/reference/yaml.md"]),
