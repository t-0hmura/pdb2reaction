...
@click.option(
    ...
    show_default=True,
    help="MLIP predictor workers; >1 spawns a parallel predictor. NOTE: the analytical Hessian (used for RFO seeding) raises a RuntimeError when workers>1; run with --workers 1 for those modes.",
)
@click.option(
    "--workers-per-node",
    "workers_per_node",
