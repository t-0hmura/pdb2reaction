...
- [**Tutorial**](docs/tutorial.md) — Worked examples (bezA case study + smoke test matrix)
...
| `energy-diagram` | Draw state energy diagram directly from numeric values                            | [`docs/energy-diagram.md`](docs/energy-diagram.md) |
